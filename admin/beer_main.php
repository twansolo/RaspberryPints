...
$sql="SELECT * FROM $tbl_name WHERE active = true";
...
<td align="center"><a href="update.php?beerid=<? echo $rows['beerid']; ?>"><img src="img/icons/pencil.png" height="30" width="30"></a></td>
<tr><td><hr></td></tr>
...
$sql="SELECT * FROM $tbl_name WHERE active='2'";
$result=mysql_query($sql);
?>	
...
<label for="textfield"><strong>Active (1=Yes 2=No):</strong></label> <input class="inputbox" type="text" name="active"> <br />
<label for="textfield"><strong>Tap Number:</strong></label> <input class="inputbox" type="text" name="tapnumber"> <br />
